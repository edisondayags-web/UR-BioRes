...
start_marker = "fun ResumeTemplate01Screen(data: ResumeTemplateFields, onFieldChange: (ResumeTemplateFields) -> Unit) {"
start = content.index(start_marker)

# find matching closing brace by counting braces from start_marker
...
while depth > 0:
    if content[i] == "{":
        ...
        depth -= 1
    i += 1
end = i  # index right after the matching closing brace

new_func = '''fun ResumeTemplate01Screen(data: ResumeTemplateFields, onFieldChange: (ResumeTemplateFields) -> Unit) {
